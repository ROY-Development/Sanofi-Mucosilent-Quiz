...
export class Renderer
{
	 ...
	 * particle ID as a key and an HTMLElement as the value.
	 */
	...
	/**
	 * Whether the renderer should actually draw particles.
	 */
	 ...
	 *
	 * @returns The number of particles that were rendered.
	 */
	public end(): number
	{
	 ...
	 * time, an HTMLElement will be created using the emitter's render settings.
	 *
	...
	): HTMLElement
	{
		...
		// Ensure that the elements can be "stacked" on top of each-other.
